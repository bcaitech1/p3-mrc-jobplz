...
def main():
    ...
    dataset_KLUE_valid = dataset_KLUE['validation'].map(features=datasets['validation'].features, 
                                                    remove_columns=['document_id', '__index_level_0__'], 
                                                    keep_in_memory=True)
    
    datasets['train'] = concatenate_datasets([dataset_KLUE_train, datasets['train'].select(range(2000))])
    datasets['validation'] = dataset_KLUE_valid # concatenate_datasets([dataset_KLUE_valid, datasets['validation']])
