...
def main():
    ...
    print(f"model args is from : \n {model_args} \n ")
    print(f"data args is from : \n {data_args} \n")
    print(f"training args is from : \n {training_args} \n")
...
def run_mrc(data_args, training_args, model_args, datasets, tokenizer, model):
    ...
    if training_args.do_train:
        ...
        train_dataset = train_dataset.map(
            ...
            load_from_cache_file=not data_args.overwrite_cache, #not False -> True
        )
...
#         evaluation_stratege=training_args.evaluation_strategy,
