...
"""
from es import ElasticRetrieval
import logging
import os
import sys
...
def main():
    ...
    # model_args.model_name_or_path = "Dongjae/mrc2reader"
    ...
    # model_args.tokenizer_name="deepset/xlm-roberta-large-squad2"
    tokenizer = AutoTokenizer.from_pretrained("deepset/xlm-roberta-large-squad2",use_fast=True)
